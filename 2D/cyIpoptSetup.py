#!/usr/bin/env python3
"""
Created on Fri Dec 15 18:35:23 2023
...
def CyIpoptWrapper(optimisationClass):
    ...
    optimisationProblem.add_option(
        "max_iter", optimisationClass.maximumNumberOfIterations
    )
    ...
    optimisationProblem.set_problem_scaling(
        obj_scaling=optimisationClass.gradientScaling
    )
