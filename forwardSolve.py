...
class ForwardSolve:
    ...
    def GenerateMesh(self,):
        self.mesh = fd.BoxMesh(self.nx, self.ny, self.nz, self.lx, self.ly, self.lz, hexahedral=True)
    ...
    def Setup(self):
        ...
        ###############################################################################
        # generate mesh
        self.nx, self.ny, self.nz = 20, 10, 10
        self.lx, self.ly, self.lz = 1, 1, 1
        self.GenerateMesh()
